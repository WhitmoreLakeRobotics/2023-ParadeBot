...
public class SubDriveTrain extends SubsystemBase {
    ...
    private TalonSRX CanSpark_driveLeft_1;
    private TalonSRX CanSpark_driveLeft_2;
    private TalonSRX CanSpark_driveRight_1;
    private TalonSRX CanSpark_driveRight_2;
...
//for full chassis uncomment other motors
        CanSpark_driveLeft_1 = new TalonSRX(CAN_ID_Constants.kCanID_DriveTrain_left_1);
        CanSpark_driveLeft_2 = new TalonSRX(CAN_ID_Constants.kCanID_DriveTrain_left_2);
        CanSpark_driveRight_1 = new TalonSRX(CAN_ID_Constants.kCanID_DriveTrain_right_1);
        CanSpark_driveRight_2 = new TalonSRX(CAN_ID_Constants.kCanID_DriveTrain_right_2);
      ...
      /* int maxCurrent = 50;
        CanSpark_driveLeft_1.ContinuousCurrentLimit(maxCurrent);
        ...
        */
        ...
        CanSpark_driveLeft_1.setNeutralMode(NeutralMode.Brake);
        //setNeutralMode(NeutralMode.Brake);

        CanSpark_driveLeft_2.setNeutralMode(NeutralMode.Brake);
        CanSpark_driveRight_1.setNeutralMode(NeutralMode.Brake);
        CanSpark_driveRight_2.setNeutralMode(NeutralMode.Brake);
...
*/
    ...
    private void setPower_LeftDrive(double pwrPercent) {
        ...
        CanSpark_driveLeft_1.set(ControlMode.PercentOutput,power);
        CanSpark_driveLeft_2.set(ControlMode.PercentOutput,power);
    }
    ...
    private void setPower_RightDrive(double pwrPercent) {
        ...
        CanSpark_driveRight_1.set(ControlMode.PercentOutput,power);
        CanSpark_driveRight_2.set(ControlMode.PercentOutput,power);
    }
...
*/
    ...
    public void stop() {
        ...
        CanSpark_driveRight_1.set(ControlMode.PercentOutput,0);
      CanSpark_driveRight_2.set(ControlMode.PercentOutput,0);
        CanSpark_driveLeft_1.set(ControlMode.PercentOutput,0);
      CanSpark_driveLeft_2.set(ControlMode.PercentOutput,0);
    }
